...
from first_step.config import SENSOR_TH, PLOT_SENSOR_DOWN
...
def measurments_to_points(meas, drone_pos):
    data = []
    roll = meas['roll']
    pitch = -meas['pitch']
    yaw = meas['yaw']
